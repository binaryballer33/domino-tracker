...
export default function DominoDots(props: DominoDotsProps) {
        ...
        switch (value) {
            ...
            case 2:
                return (
                    <div className="relative h-full w-full">
                        <div
                            className={`absolute left-[25%] top-[25%] rounded-full bg-black dark:bg-white ${dotSize}`}
                        />
                        <div
            ...
            case 4:
                return (
                    <div className="relative h-full w-full">
                        ...
                        />
                        <div
                            className={`absolute right-[25%] top-[25%] rounded-full bg-black dark:bg-white ${dotSize}`}
                        />
                        <div
    ...
    return <div className="flex h-full w-full items-center justify-center">{renderDots()}</div>
}
